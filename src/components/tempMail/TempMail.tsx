...
const TempMail: React.FC<TempMailProps> = ({ backendUrl = 'http://localhost:5000' }) => {
  ...
  return (
    <div className="w-full h-full p-5">
        ...
        <div className="mt-5">
          ...
          <div className="space-y-4">
            {emails.map((msg, index) => (
              <div key={index} className="border border-gray-200 rounded p-4 shadow-sm">
      ...
      {savedEmails.length > 0 && (
        <div className="mt-5">
          <h2 className="text-xl font-semibold mb-2">Previously Created Emails</h2>
